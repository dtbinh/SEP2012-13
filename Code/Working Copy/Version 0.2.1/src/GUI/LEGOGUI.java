...
public class LEGOGUI extends JFrame {
    /********************** Map GUI Panel component **************/
     ...
     private MenuItem file_save,file_setNoGoZone,file_UndoNoGoZone,connect_connectRob,connect_disconRob,start_navigation,manual_scan;
...
//     private MapCanvas canvas;
    ...
    public void reInitialMap(){
     ...
     public void MenuBarInitail(){
        ...
        MenuItem  user_mode, developer_mode;
        ...
        file_UndoNoGoZone = new MenuItem();
        ...
        set_battery = new MenuItem();
        {
            ...
            setMenuItem(edit_menu, file_setNoGoZone, "Set No Go Zone", KeyEvent.VK_G);
            setMenuItem(edit_menu, file_UndoNoGoZone, "Set No Go Zone", KeyEvent.VK_G);
    ...
    public class UndoNoGoZoneListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
