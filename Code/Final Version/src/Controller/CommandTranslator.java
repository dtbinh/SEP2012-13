package Controller;
/**
 * Command translator translate string command into command protocol.
 * @author DaweiG
...
public class CommandTranslator {
	 ...
	 * @param input
	 * @return command which can be pushed in queue
	 */
