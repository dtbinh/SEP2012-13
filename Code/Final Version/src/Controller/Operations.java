package Controller;
/**
 * Operation protocols using by the Host.
 * @author DaweiG
...
public class Operations {
	...
	/**
	 * Manual control operation protocols
	 */
	...
	/**
	 * Auto and Manual scan protocols
	 */
	...
	public static final int PC_COMMAND_FORWARD = 1;
	public static final int PC_COMMAND_BACKWARD = 2;
	public static final int PC_COMMAND_LEFT = 3;
	public static final int PC_COMMAND_RIGHT = 4;
	
	public static final int PC_COMMAND_FORWARD_1_PIXEL = 5;
	public static final int PC_COMMAND_BACKWARD_1_PIXEL = 6;
	public static final int PC_COMMAND_LEFT_ONE_1_PIXEL = 7;
	public static final int PC_COMMAND_RIGHT_1_PIXEL = 8;
	public static final int PC_COMMAND_TURN_AROUND_1_PIXEL = 9;
	
	public static final int PC_COMMAND_WALL = 10;
	public static final int PC_COMMAND_GROUND = 11;
	public static final int PC_COMMAND_STOP = 12;
	public static final int PC_COMMAND_BATTERY = 13;
	public static final int PC_COMMAND_SET_SPEED = 14;
	public static final int PC_COMMAND_QUIT = 15;
