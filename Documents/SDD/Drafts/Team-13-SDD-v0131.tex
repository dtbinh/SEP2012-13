...
% a client.BluetoothHost object via a Blue-tooth link. it shall transmit a Blue-tooth signal
...
% Function This class opens a Blue-tooth I/O stream to receive input from a
