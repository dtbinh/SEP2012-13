...
\chapter{Definitions}
\begin{tabular}{|c|p{10cm}|}%{| l | l | l | l | }
\hline
...
\begin{tabular}{|p{2cm}|p{3cm}|p{2cm}|p{2cm}|p{2cm}|p{5cm}|}%{| l | l | l | l | }
\hline
ID	&	Name	&	Start	&	End	&	Duration  & 	Task  \\ \hline
P	&	Poster	&	31/07/12	&	3/08/12	&	4 days &	Design a poster for our group, with every group member's information. Print out the poster before the due date. \\ \hline
SRS1D	&	Software Requirements Specification 1st Draft	&	8/08/12	&	20/08/12	&	9 days &	Divide the SRS document into parts in the group meeting. Every group member completes the parts he assigned to. \\ \hline
SPMP1D	&	Software Project Management Plan 1st Draft	&	20/08/12	&	3/09/12	&	10 days &	Divide the first SPMP draft document task into parts in the group meeting. Every group member completes the parts he assigned to. \\ \hline
SDD1D	&	Software Design Document 1st Draft	&	27/08/12	&	14/09/12	&	4 days &	Divide the first SDD draft document task into parts in the group meeting. Every group member completes the pieces he assigned to.\\ \hline
TR	& 	Test Report 	&	10/09/12 & 05/10/12	& 20 days	& Test every implemented function during these four weeks, add the test result to the test report after every testing. \\ \hline
UM	&  User Manual & 28/09/12 & 19/10/12 & 15 days& User Manual is divided into different parts according to the robot's functions. Every group member is required to write the part of the function that he developed. \\ \hline
MN1		& 	Milestone Negotiation1	 &	 13/08/12	 &	 20/08/12	 &	 5 days & Negotiating with the client to decide the tasks of the Milestone1  \\ \hline
MN2		& 	Milestone Negotiation2	 &	 7/09/12	 &	 14/09/12	 &	 5 days & Negotiating with the client to decide the tasks of the Milestone2  \\ \hline
GUIF		&	GUI Framework	&  2/08/12	&	7/08/12	& 5 days	&	Designing the farm of the GUI \\  \hline
GUICP		&	GUI Control Panel	&  2/08/12	&	7/08/12	& 5 days	&	Build the control panel of the GUI \\  \hline
GUIFDP	&	GUI Map Display Panel	&  6/08/12	&	7/08/12	& 1 days	&	Build the display panel of the GUI \\  \hline
...
%RMM		&	Robot Movement Milestone 	&  20/08/12	&	20/08/12	& 1 days	&	None \\  \hline
 \pagebreak
\begin{tabular}{|p{2cm}|p{3cm}|p{2cm}|p{2cm}|p{2cm}|p{3cm}|}%{| l | l | l | l | }
\hline
ID	&	Name	&	Start	&	End	&	Duration  & 	Task  \\ \hline
