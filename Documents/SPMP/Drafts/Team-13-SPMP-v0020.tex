...
\subparagraph  
\items 2.1 different versions of PDF draft
\subparagraph  
\items 2.2 different versions of TEX draft 
\paragraph{3. agendas}
This folder contains the agendas of the Client Meeting and Internal Meeting.
\subparagraph
\items 3.1 Team-13-InternalMeeting-"times of the meeting"-Agenda.pdf
\subparagraph
\items 3.2 Team-13-InternalMeeting-"times of the meeting"-Agenda.tex
\subparagraph
\items 3.3 Team-13-Meeting-"times of the meeting"-Agenda.pdf
\subparagraph
\items 3.4 Team-13-Meeting-"times of the meeting"-Agenda.tex
...
\subparagraph
\items 3.1 Team-13-InternalMeeting-"times of the meeting"-Minutes.pdf
\subparagraph
\items 3.2 Team-13-InternalMeeting-"times of the meeting"-Minutes.tex
\subparagraph
\items 3.3 Team-13-Meeting-"times of the meeting"-Minutes.pdf
\subparagraph
\items 3.4 Team-13-Meeting-"times of the meeting"-Minutes.tex
...
The purpose of this document is to ensure that all students participate the testing process for the software development. Every group member is required to write a testing report to demonstrate some test case.           
...
\subparagraph
\items 1. When the developers build the Java Folder, the developers are required to use the function of this java program as the folder name. For example, GUI developers are required to name the folder as GUI, the robot developers are required to name the folder as Movement or Sensor detection. In this way, other developers are convenient to find the needed java program.
\subparagraph
\items 2. The developers are required to write the developer's name, writing date and the brief explanation of this file's function on the top of each java file. This standard is used to make the java file more clear to be read. Meanwhile, code checkers is more convenient to check the author and the fix date.  
\subparagraph
\items 3. The developers are required to write the specific comments for each method, which is convenient for others to read and save the reading time.
\subparagraph
\items 4. The group members who modify others' program are required to write the name and the fix date on the bottom of the java file. The modify part is also needed to be labbelled.  
\paragraph{Documents standard}
\subparagraph
\items 1. The file name of each documents(except minutes and agendas) is required to write in format like this: Team-13-document's name-version. The client minutes is required to write in format like this:
...
\subparagraph
\items 2. Each group member is required to understand how to use Latex to write the file. When developers submit the documents, it is necessary to upload both the tex and pdf file.
\subparagraph
\items 3.  The documents must be summited in the correct folder. For example, the minutes have to summit in the minutes folder. It is not allowed to summit the files in the wrong folder. The developer has to make sure the documents summit in right place. 
   \subparagraph
\items 4.  If one developer wants to delete documents, it is required to negotiate with the other group members. 
\pagebreak
