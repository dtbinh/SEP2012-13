...
%%%%%%
%%%%%%   Lack of image "robot_mode_change"!  @dawei geng
%%%%%%
%%%%%%
\begin{figure}[ht]
\centering
...
\setlength\fboxsep{2pt}
\setlength\fboxrule{0.2pt}
\fbox{\includegraphics[width =0.8\linewidth]{newGUI}}
...
\setlength\fboxsep{2pt}
\setlength\fboxrule{0.2pt}
\fbox{\includegraphics[width =0.8\linewidth]{newGUI_map}}
